...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="#">添加文章分类</a>
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/category/'.$field->cate_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th></th>
                    <td>
                        <input type="text" class="lg" name="cate_title" value="{{url($field->cate_title)}}">
                        <p>标题可以写30个字</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span><i class="fa fa-exclamation-circle yellow"></i>这里是整数</span>
                    </td>
                </tr>
