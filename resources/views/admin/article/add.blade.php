    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                ...
                <a href="{{url('admin/article')}}"><i class="fa fa-recycle">文章列表</i></a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
        ...
        <form action="{{url('admin/article')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="art_title" alt="" >
                        <p>标题可以写30个字</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th></th>
                    <td><img src=""  id="art_thumb_img" style="max-width:350px;max-height:100px;"></td>
                </tr>
                <tr>
                    <th>描述：</th>
                    <td>
