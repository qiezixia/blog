@extends('layouts.admin')
    @section('content')
        ...
        <div class="crumb_warp">
            ...
            <i class="fa fa-home"></i> <a href="{{url('admin/info')}}}" target="_blank">首页</a> &raquo;文章管理
        </div>
        <!--面包屑导航 结束-->
            ...
            <div class="result_wrap">
                ...
                <div class="result_content">
                    <div class="short_wrap">
                        ...
                        <a href="{{url('admin/category/create')}}"><i class="fa fa-recycle"></i>新增分类</a>
                    </div>
                </div>
                <!--快捷导航 结束-->
            </div>
                ...
                <div class="result_content">
                    <table class="list_tab">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('/a/'.$v->art_id)}}" target="_blank">{{$v->art_title}}</a>
                            </td>
                            <td>{{$v->art_view}}</td>
                            <td>{{$v->art_editor}}</td>
