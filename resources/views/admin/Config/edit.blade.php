    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/config/create')}}"><i class="fa fa-plus">添加配置项</i></a>
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio"  name="field_type" value="radio" onclick="showTr()" @if($data->field_type=='radio') checked @endif>radio
                    </td>
                </tr>
