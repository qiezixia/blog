...
$(function() {
	$.fn.smohanfacebox = function(options) {
		...
		//创建表情框{{asset('resources/views/home/images/face/'+(i+1).gif)}}
		var faceimg = '';
	    for(i=0;i<60;i++){  //通过循环创建60个表情，可扩展
            faceimg+='<li><a href="javascript:void(0)"><img src="./../resources/views/home/images/face/'+(i+1)+'.gif" face="<emt>'+(i+1)+'</emt>"/></a></li>';
		 };
